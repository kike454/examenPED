...
class Kata:
    ...
    def startsWithA(self,cadena):
        ...
        if cadena1.startswith("a") or cadena1.startswith("A"):
            return True
        else:
            return False
    ...
    def annadirZDespuesDeUnaA(self,cadena):
        ...
        cadena_nueva = cadena1.lower().replace("a" ,"a"  +  caracter_a_insertar)
    ...
    def annadirXTresPosicionesMasDeUnaJ(self,cadena):
        ...
        cadena_nueva = cadena1[:posicion_insercion] + caracter_a_insertar + cadena1[posicion_insercion:]
